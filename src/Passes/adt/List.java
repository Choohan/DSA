...
public interface List<E> {
     ...
     *
     * @param  array that is abstract to be checked for containment in this list
     ...
     *
     * @param array that is abstract containing elements to be removed from this list
     * @return {@code true} if this list changed as a result of the call
     ...
     * specified collection.
     *
     * @param array that is abstract containing elements to be retained in this list
     * @return {@code true} if this list changed as a result of the call
